function onCreate()
	-- background shit
	makeLuaSprite('arcadev2bg', 'arcadev2bg', -600, -200);
	setLuaSpriteScrollFactor('arcadev2bg', 0.9, 0.9);
	...
	makeAnimatedLuaSprite('gf', 'Kapi_gfCar', 0, 0)
