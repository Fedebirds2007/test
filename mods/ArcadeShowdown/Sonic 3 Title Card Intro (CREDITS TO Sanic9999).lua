function onCreatePost() -- CREDITS TO Sanic9999.
	--Variable Shit
		TitleCardType = 'Sonic 3' -- the type of title card you want, the current options are 'Sonic 2', 'Sonic 3'.
		TheCustomZoneName = "Carnival Night" --custom zone name text.
		CustomZoneName = true -- put to true if you want a custom zone name or else it will be the song name.
		ZoneFont = "Andes.ttf" -- the font used for the zone name, the current options are 'Andes.ttf'(S3&K), 'Gaslight.ttf'(S2), or whatever font you have in your fonts folder.
		...
		actnum = '2' -- the act number you want displayed, the options are: '1' '2' '1 no act text' '2 no act text'. if you are using Sonic 2 title cards, it can be whatever you want.
