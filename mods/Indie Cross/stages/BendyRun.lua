function onCreate()
	...
	addAnimationByPrefix('BendyBGRun','Loop0', 'Loop01 instance 1', 70, true);
	addAnimationByPrefix('BendyBGRun','Loop1', 'Loop02 instance 1', 70, true);
	addAnimationByPrefix('BendyBGRun','Loop2', 'Loop03 instance 1', 70, true);
	addAnimationByPrefix('BendyBGRun','Loop3', 'Loop04 instance 1', 70, true);
	addAnimationByPrefix('BendyBGRun','Loop4', 'Loop05 instance 1', 70, true);
	...
	addAnimationByPrefix('Transition','Trans','beb instance 1', 30, true);
