...
function onCreate()
  if songName == 'build-our-freaky-machine' then
      precacheImage('bendy/images/BonusSongs/dabg - Black & White')
      precacheImage('bendy/images/BonusSongs/reel')
      precacheImage('bendy/images/BonusSongs/Curtain1 - Black & Whitel')
      precacheImage('bendy/images/BonusSongs/Curtain2 - Black & White')
      precacheImage('bendy/images/BonusSongs/dabg - Black & White')
      precacheImage('bendy/images/BonusSongs/dabg - Black & White')
      precacheImage('bendy/images/BonusSongs/dabg - Black & White')
...
function onCreatePost()
  makeLuaSprite('precacheNote','bendy/images/BonusSongs/NOTE_assets',0,0)
  setProperty('precacheNote.visible',false)
end
...
function onStepHit()
    ...
    if songName == 'build-our-freaky-machine' then
      if curStep == 1280 then
          ...
          setProperty('Curtain1BlackWhite.alpha',true)
